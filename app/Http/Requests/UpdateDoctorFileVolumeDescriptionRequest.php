...
class UpdateDoctorFileVolumeDescriptionRequest extends FormRequest
{
    ...
    public function toDTO(): UpdateDoctorFileVolumeDescriptionDTO
    {
        return UpdateDoctorFileVolumeDescriptionDTO::createFromRequest($this);
    }
}
