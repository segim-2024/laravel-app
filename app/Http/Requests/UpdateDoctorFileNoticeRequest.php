...
class UpdateDoctorFileNoticeRequest extends FormRequest
{
    public bool $isWhale;
...
//            }
    ...
    public function toDTO(): UpdateDoctorFileNoticeDTO
    {
        return UpdateDoctorFileNoticeDTO::createFromRequest($this);
    }
}
