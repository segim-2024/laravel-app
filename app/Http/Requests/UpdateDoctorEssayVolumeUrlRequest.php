...
class UpdateDoctorEssayVolumeUrlRequest extends FormRequest implements HasReferrerCheck
{
    /**
    ...
    public function toDTO(): UpdateDoctorEssayVolumeUrlDTO
    {
        return UpdateDoctorEssayVolumeUrlDTO::createFromRequest($this);
    }
