...
class UpdateDoctorFileVolumeIsPublishedRequest extends FormRequest
{
    ...
    public function toDTO(): UpdateDoctorFileVolumeIsPublishedDTO
    {
        return UpdateDoctorFileVolumeIsPublishedDTO::createFromRequest($this);
    }
}
