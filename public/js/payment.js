document.addEventListener('DOMContentLoaded', function() {
    // ------ 클라이언트 키로 객체 초기화 ------
    const clientKey = document.querySelector('#tossCk').value
        ...
        registrationButton.addEventListener('click', function() {
            ...
            tossPayments
                .requestBillingAuth('카드', {
                    ...
                    // 결제 정보 파라미터
                    customerKey: document.querySelector('#customerKey').value, // 구매자 ID로 상점에서 만들어야 합니다. 빌링키와 매핑됩니다. 자세한 파라미터 설명은 파라미터 설명을 참고하세요: https://docs.tosspayments.com/reference/js-sdk#결제-정보-5
